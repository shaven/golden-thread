...
| `core_parallel_when_beneficial.md` | Core/Reminder — parallelise divisible work in every project, up to the `parallel_max` budget; serial execution must be justified. Governs what is run AND what is written. Designated by the user 2026-09-12. |
